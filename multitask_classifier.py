...
class MultitaskBERT(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.paraphrase_type_linear = nn.Linear(BERT_HIDDEN_SIZE*2,7)
    ...
    def forward(self, input_ids, attention_mask):
        ...
        embeddings = self.bert(input_ids, attention_mask)["last_hidden_state"][:,0]
        return embeddings
    ...
    def predict_sentiment(self, input_ids, attention_mask):
        ...
        prediction = self.sentiment_linear(embedding)
        return prediction
        ### TODO
    ...
    def predict_paraphrase(self, input_ids_1, attention_mask_1, input_ids_2, attention_mask_2):
        ...
        prediction = self.paraphrase_linear(torch.concatenate((embedding_1,embedding_2),dim=1))
        return prediction
        ### TODO
    ...
    def predict_similarity(self, input_ids_1, attention_mask_1, input_ids_2, attention_mask_2):
        ...
        embedding_1 = self.forward(input_ids_1, attention_mask_1)
        embedding_2 = self.forward(input_ids_2, attention_mask_2)
        prediction = self.similarity_linear(torch.concatenate((embedding_1,embedding_2),dim=1))
        prediction = F.sigmoid(prediction)*5
        return prediction
        ### TODO
    ...
    def predict_paraphrase_types(
        ...
        embedding_1 = self.forward(input_ids_1, attention_mask_1)
        embedding_2 = self.forward(input_ids_2, attention_mask_2)
        prediction = self.paraphrase_type_linear(torch.concatenate((embedding_1,embedding_2),dim=1))
        return prediction
        ### TODO
    ...
    for epoch in range(args.epochs):
        ...
        if args.task == "sts" or args.task == "multitask":
            ...
            for batch in tqdm(
                ...
                loss = F.mse_loss(logits.squeeze(), b_labels.view(-1))
                loss.backward()
                optimizer.step()
        ...
        if args.task == "qqp" or args.task == "multitask":
            ...
            for batch in tqdm(
                ...
                loss = F.binary_cross_entropy_with_logits(logits.squeeze(), b_labels.view(-1))
                loss.backward()
                optimizer.step()
